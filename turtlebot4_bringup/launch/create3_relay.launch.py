...
def generate_launch_description():
    ...
    cmd_vel_unstamped_relay = Node(
        package='topic_tools',
        executable='relay',
        name='turtlebot4_relay_cmd_vel_unstamped',
        arguments=['/cmd_vel_unstamped', '/create3/cmd_vel'],
        output='screen'
    )
    ...
    cmd_vel_relay = Node(
        ...
        arguments=['/cmd_vel', '/create3/cmd_vel_stamped'],
        output='screen'
    )
    ...
    ld.add_action(cmd_vel_unstamped_relay)
